...
class CoreDataStack {
    ...
    lazy var notPersistentContainer: NSPersistentContainer = {
        /*
         The persistent container for the application. This implementation
         creates and returns a container, having loaded the store for the
         application to it. This property is optional since there are legitimate
...
struct CoreDataHelper {
    ...
    static let notPersistentContainer = CoreDataStack.sharedInstance.notPersistentContainer
    static let unmanagedContext = notPersistentContainer.viewContext
